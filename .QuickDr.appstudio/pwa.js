...
const cacheName = '_QuickDr-2022-04-29 08:40:02.107510'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_QuickDr'.length) === '_QuickDr') {
